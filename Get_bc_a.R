...
BRCA2_SS_11Nt_pos_a <- read.csv("/gpfs/project/azlan/Firstlib/R_processed_Data/BRCA2_total_bc_pos/BRCA2_total_Barcode_pos_a.csv", sep = ";")
...
write.csv2(BRCA2_ssbc_dF, file = "/gpfs/project/azlan/Firstlib/R_processed_Data/BRCA2_total_bc/BRCA2_total_Barcode_a.csv", row.names = F)